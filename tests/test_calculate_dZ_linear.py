...
def test_calculate_dZ_linear():
    print()
    print("Calculate dZ function test (Linear):")
    ...
    expected_output = np.dot(W_next.T, dZ_next) * linear_derivative(Z)
    ...
    print("\nCalculate dZ function test (Linear) passed!")
